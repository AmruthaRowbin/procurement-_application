...
import { addOrderAsync, fetchOderAsync } from '../redux/slices/purchaseorderSlice';
...
const Addpurchaseorder = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const orderData = {
            orderNo: `PO-${Date.now()}`, // Simple unique order number
            supplier: supplierId,
            orderDate,
            itemTotal,
            discount,
        ...
        dispatch(addOrderAsync(orderData,supplierId)).then(() => {
